      ...
      <div className="navbar-wrapper">
        <div className="m-header h-header-height flex items-center px-6 py-4">
          <Link href="/" className="b-brand flex items-center gap-3">
            <Image src={LogoWhite} className="img-fluid logo logo-lg" alt="logo" width={140} height={32} priority />
            <Image src={fevicon} className="img-fluid logo logo-sm" alt="logo" width={32} height={32} priority />
          </Link>
        </div>
